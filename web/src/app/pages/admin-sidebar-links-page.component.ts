...
export class AdminSidebarLinksPageComponent {
  ...
  protected readonly items = this.repo.watchAll(); protected readonly articleItems = this.loadArticles(); protected open = false; protected id: string | null = null; protected label = ''; protected type: SidebarLinkType = 'article'; protected articleSlug = ''; protected url = ''; protected section: SidebarLinkSection = 'other'; protected saving = false;
  protected readonly typeOptions: Array<{ value: SidebarLinkType; label: string }> = [{ value: 'article', label: 'บทความภายใน' }, { value: 'external', label: 'ลิงก์ภายนอก' }];
